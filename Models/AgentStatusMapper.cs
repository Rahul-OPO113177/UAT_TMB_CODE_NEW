...
namespace ServerCRM.Services
{
    public static class AgentStatusMapper
    {
        ...
        public static readonly Dictionary<int, string> StatusMap = new()
        {
            ...
            [12] = "Emergency",
            [13] = "MANUAL_DIALING",
            [14] = "Backend_Work_BREAK",
            [15] = "Back_to_School_BREAK",
            [16] = "CM_Feedback_BREAK",
            [17] = "Dialer_NonTech_DownTime_BREAK",
            [18] = "Dailer_Tech_DownTime_BREAK",
            [19] = "Floor_Help BREAK",
            [20] = "Health_Activities_BREAK",
            [21] = "Scheduled_BREAK",
            [22] = "Team_Huddle_BREAK",
            [23] = "Tech_DownTime_BREAK",
            [24] = "Townhall_BREAK",
            [25] = "Unwell_BREAK",
            [26] = "TL_FeedBack",
            [27] = "VatBreak"
        ...
        public static void SaveStatusHistoryToDatabase(AgentStatusHistory history)
        {
            try
            {
                const string connectionString = "server=172.24.11.82;user=dba;password=Opo@1234;database=DATAMART;";
